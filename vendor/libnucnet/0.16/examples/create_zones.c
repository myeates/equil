...
int main( int argc, char * argv[] ) {
  ...
  /*============================================================================
  // Relabel the zone and print out the abundances again.
  //==========================================================================*/

  fprintf(
    stdout,
    "Relabel the zone and update and print out the abundances again:\n\n"
  );
  ...
  fprintf(
    stdout,
    "Copy the zone, relabel the copied zone,  update, and print out the abundances again:\n\n"
  );
