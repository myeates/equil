...
#define NET_XSD_VERSION "2011-05-28"
...
//     <doc kind="example" id="example1">
//       <synopsis>
//         Iterate over the all network view in zone p_zone and
//         apply my_func and the extra data pointed to by p_user_data:
//       </synopsis>
//
//       <code>
...
//     <doc kind="example" id="example2">
//       <synopsis>
//         Iterate over all the network views that match "my view"
...
//
//       <code>
// p_evol_view = Libnucnet__getEvolutionNetView( p_zone );
//       </code>
//     </doc>
//
//   </usage>
