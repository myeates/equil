...
xsltproc http://www.webnucleo.org/share/code/xml_utilities/0.1/xsl/regression_tests/module_examples_regression_test_script_maker.xsl examples.xml > regression_execute.sh
